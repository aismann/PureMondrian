;PureMondrian 1.2.1 by Jac de Lad
EnableExplicit
UsePNGImageDecoder()
UseGIFImageDecoder()
...
Procedure DrawTools()
  ...
  DrawTool(X-24,#Image_Solve,#Image_SolveBW,1)
...
OpenWindow(#MainWindow,0,0,700,630,"PureMondrian 1.2.1",#PB_Window_ScreenCentered|#PB_Window_SystemMenu|#PB_Window_MinimizeGadget)
...
DataSection
  ...
  ;Winning animation:
  Win:   : IncludeBinary "Win.anim"   : WinEnd:
EndDataSection
